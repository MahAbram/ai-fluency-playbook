...
This playbook is comprehensive. You do not need to read all of it.
...
When you search Google, you type fragmented keywords and the engine retrieves links. When you prompt an AI, you are briefing a new hire who has read every book on the internet but knows absolutely nothing about your company, your tone, or your goals. The intern is brilliant but completely context-blind. If you give them a vague task, you get a generic result. If you give them context, clarity, constraints, and the source material to work from, you get a usable draft.
...
* **Context:** Who is the AI acting as, who is the audience, and why does the task matter?
* **Clarity:** What exact action do you want — summarize, compare, extract, draft?
* **Constraint:** What format, length, tone, and what should the AI *not* do?
* **Content:** What source material should it work from? (Paste it in.)
...
> **[Context]** You are a [your role] writing for [your audience]. The goal of this task is [why it matters].
> **[Clarity]** [Verb the AI should do]. Specifically: [the exact output you want].
> **[Constraint]** Format the output as [structure]. Keep it under [length]. Do not [things to avoid].
> **[Content]** Here is the source material to work from: [paste it].
...
* **If you are leading AI adoption for your team:** Read Chapter 2.2 ("Ethical Usage & Guardrails") and Chapter 4.3 ("Enterprise Considerations").
* **If you are deciding which tool to use:** Read Chapter 4.2 ("The Big Four Model Matrix").

Everything else in this playbook supports these four ideas. If you only ever read this chapter, you will still be ahead of the majority of professionals using these tools today.
